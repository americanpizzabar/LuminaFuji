...
export const products: Product[] = [
  {
    id: 'brite-3',
    name: 'Brite 3',
    tagline: 'OLEDWorks 有機ELパネル（電球色 3000K）',
    description:
      'OLEDWorks 社の有機ELパネル「Brite 3」。面全体が均一にやわらかく発光し、まぶしさのない自然光のような光環境を実現します。色温度は電球色 3000K に固定され、OLED特有の性質として光を絞るほど自然に暖かみが増します（dim-to-warm）。このレジデンスのリビングで使用中のモデルです。',
    price: '¥ 890,000〜',
    specs: {
      サイズ: '1200 × 600 mm',
      厚さ: '8 mm',
      ...
      演色性: 'CRI 90+（R9 > 50）',
      寿命: '100,000 時間',
      調光方式: 'DALI-2 / 0-10V（明るさ調光）',
      消費電力: '80 W',
      重量: '3.2 kg',
      保証: '5年',
    },
    features: ['自然な暖色調光 (dim-to-warm)', 'フリッカーフリー', 'UV ゼロ', '無赤外線', '面発光・低まぶしさ'],
    category: 'panel',
    featured: true,
