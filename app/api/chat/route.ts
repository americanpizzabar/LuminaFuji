...
## 照明について
- 客室内の照明は全て有機EL (OLED) パネル
- Brite 3: リビングメイン照明 (OLEDWorks製、電球色3000K固定、明るさ調光可能)
  - 色温度は固定です。OLEDの特性で、明るさを絞ると自然に暖かな色合いに変化します (dim-to-warm)
- Luna Series: 寝室の壁面照明
- アプリの「照明」タブから明るさ・シーン・エリアを操作できます (色温度の変更はありません)
- 照明の実際の操作はご滞在中のみ可能です
