    ...
    <>
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-0.5">通知設定・施設基本情報</p>
        </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-zinc-500 mt-0.5">リクエスト受信時にメールで通知</p>
              </div>
            ...
            <AnimatePresence>
              {emailEnabled && (
                ...
                >
                  <div className="pt-1">
                    <label className="text-xs text-zinc-500 mb-1 block">メールアドレス</label>
                    <input
                      type="email"
                      value={emailAddress}
                      onChange={e => setEmailAddress(e.target.value)}
                      placeholder="your@email.com"
                      className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-600 focus:outline-none focus:border-teal-500/40 transition-all"
                    />
                  </div>
                </motion.div>
              )}
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-zinc-500 mt-0.5">LINEアプリでリアルタイム通知</p>
              </div>
              ...
              {lineNotifyEnabled && (
                ...
                >
                  <div className="pt-1 space-y-2">
                    <label className="text-xs text-zinc-500 mb-1 block">LINE Notify トークン</label>
                    <div className="relative flex items-center">
                      <input
                        ...
                        placeholder="トークンを入力..."
                        className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2.5 pr-10 text-sm text-zinc-100 placeholder:text-zinc-600 focus:outline-none focus:border-teal-500/40 transition-all"
                      />
                      <button
                        type="button"
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-zinc-500 mt-0.5">Slackチャンネルに通知</p>
              </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
          ...
          <div className="space-y-3.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs text-zinc-500 mb-1 flex items-center gap-1 block">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-600 focus:outline-none focus:border-teal-500/40 transition-all resize-none"
              />
            </div>
            <div>
            ...
            <div>
              <label className="text-xs text-zinc-500 mb-2 flex items-center gap-1 block">
