...
import {
  ...
  Megaphone, Lock, Save, Zap, ArrowRight, MapPin,
} from 'lucide-react'
    ...
    <div>
      ...
      <div className="relative flex items-center">
        <input
          ...
          className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-blue-500/50 transition-all pr-10"
        />
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-zinc-300 mt-0.5">施設情報・アプリの設定</p>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
          ...
          <div className="space-y-3.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs text-zinc-300 mb-1 block flex items-center gap-1">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-blue-500/50 transition-all"
              />
            </div>
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2.5 pr-10 text-sm text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-blue-500/50 transition-all"
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-blue-500/50 transition-all resize-none"
              />
            </div>
            <div>
            ...
            <div>
              <label className="text-xs text-zinc-300 mb-2 block flex items-center gap-1">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
          ...
          {activeAnn && (
            <div className="mb-4 p-3 bg-zinc-800/50 border border-zinc-700 rounded-xl">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-[11px] text-emerald-400">現在のお知らせ</span>
              ...
              {activeAnn.contentEn && (
                <p className="text-xs text-zinc-300 leading-relaxed mt-1">{activeAnn.contentEn}</p>
              )}
            </div>
          )}
          ...
          <div className="space-y-3">
            {/* Announcement type */}
            <div>
              <label className="text-xs text-zinc-300 mb-2 block">種別</label>
                ...
                {ANNOUNCEMENT_TYPES.map(({ value, label, color }) => (
                  <button
                    ...
                    className={`text-xs px-3 py-1.5 rounded-xl border transition-all ${
                      annType === value ? color : 'border-zinc-700 text-zinc-300 hover:border-zinc-600'
                    }`}
                  >
                    {label}
                  </button>
            ...
            <div>
              <label className="text-xs text-zinc-300 mb-1 block">内容（日本語）</label>
              <textarea
                rows={2}
                value={annContent}
            ...
            <div>
              <label className="text-xs text-zinc-300 mb-1 block">内容（英語）</label>
              <textarea
                rows={2}
                value={annContentEn}
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
          ...
          <div className="space-y-3">
            <div>
              <label className="text-xs text-zinc-300 mb-1 block">現在のPIN</label>
              <div className="relative flex items-center">
                <input
            ...
            <div>
              <label className="text-xs text-zinc-300 mb-1 block">新しいPIN</label>
              <input
                type={showPin ? 'text' : 'password'}
                value={newPin}
            ...
            <div>
              <label className="text-xs text-zinc-300 mb-1 block">新しいPIN（確認）</label>
              <input
                type={showPin ? 'text' : 'password'}
                value={confirmPin}
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
          ...
          <p className="text-xs text-zinc-300 mb-3">AIコンシェルジュが対応する言語</p>
